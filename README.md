...
x  = seg_model.predict_multiple(inp_dir = path, out_dir = pred_path)
```
## Load weights
```
...
process_images(image_paths, mask_paths, text_paths, width_paths, base_path, inter_row_NL, inter_row_NL_OL, final_numb)
```
